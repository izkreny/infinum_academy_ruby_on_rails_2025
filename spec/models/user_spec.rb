RSpec.describe User, type: :model do
  describe 'validations' do
    ...
    it { should !allow_value('user_email.com').for(:email) } # rubocop:disable RSpec/ImplicitExpect
    it { should !allow_value('user@email_com').for(:email) } # rubocop:disable RSpec/ImplicitExpect
  end
